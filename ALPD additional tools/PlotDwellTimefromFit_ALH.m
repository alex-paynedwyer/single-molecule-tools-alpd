...
ch = 2; %2;                         %INPUT REQUIRED
binwidth = round(1000*params.frameTime,1);
...
dwellset = trackset(:,9)*params.frameTime*1000;
...
rangemax = 80;%max([dwellbins(end),4000*params.frameTime]);  %set the axis limit to at least 4 frames
