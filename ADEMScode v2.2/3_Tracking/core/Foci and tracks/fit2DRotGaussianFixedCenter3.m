function [sdx, sdy, Icent,theta] = fit2DRotGaussianFixedCenter3(image_data,Ibg_avg, Isp, x_centre, y_centre,myfit,options,p)
...
options.StartPoint = [sdx_start, sdy_start,theta_start];
...
options.Lower = [sdx_lower, sdy_lower,theta_lower];
...
options.upper = [sdx_upper, sdy_upper,theta_upper];
