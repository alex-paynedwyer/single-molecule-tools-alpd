...
function [strregframech1,regframech2,framech1,framech2,CellObject]=prepRegImages(BFImage,p,gaussweight,histeqflag)
...
strregframech1 = uint16(double(cropframech1).*(gaussstrength*gaussfactor+1.0-gaussstrength));
regframech2 = uint16(double(cropframech2).*(gaussstrength*gaussfactor+1.0-gaussstrength));
else
   strregframech1=cropframech1;
   regframech2=cropframech2;
end
