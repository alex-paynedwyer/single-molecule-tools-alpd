...
% non-parametric test for the relative treatment effect p. If a significant
...
%
% function [p_value]=brunner_munzel(sample1, sample2)
%
% Required Inputs:
%  sample1 - first sample, can be different in length from the second
%  sample2 - second sample to be tested against the first
%
% Output:
...
% Heidelberg
% December 2018
function p_value = brunnerMunzel(sample1, sample2)
